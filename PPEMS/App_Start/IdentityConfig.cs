...
namespace PPEMS
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            {
                From = new MailAddress("pakenggeneering@gmail.com", "Pak - Engineering"),
                Subject = "Pak - Engineering",
                IsBodyHtml = true,
                Body = message.Body
            };
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<PPEMSContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var store = new RoleStore<IdentityRole>(context.Get<PPEMSContext>());
